...
'''
The Network Architecture is based on Figure 1

Decoder network's Depth-to-Space is implemented by using
torch.nn.functional.pixel_shuffle().
Depth-to-Space is used to reduce the depth during the decoding
process. It is discussed in detail at Paragraph 5, Section 2.

For an output with size (512, H, W),
it will be rearranged to (512/2/2, H*2, W*2) after applied pixel_shuffle.
'''
